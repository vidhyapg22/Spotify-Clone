...
import com.plcoding.spotifycloneyt.exoplayer.callbacks.MusicPlayerNotificatonListener
...
class MusicService : MediaBrowserServiceCompat() {
    ...
    private val serviceScope =  CoroutineScope(Dispatchers.Main + serviceJob)        //and here we will launch our coroutinesThis will deal with cancellation of coroutines
    ...
    override fun onCreate() {
        ...
        musicNotificationManager = MusicNotificationManager(
            ...
            MusicPlayerNotificatonListener(this)
        ){
